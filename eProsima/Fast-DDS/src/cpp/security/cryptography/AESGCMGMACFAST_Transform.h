...
/*!
 * @file AESGCMGMACFAST_Transform.h
 */

#ifndef _SECURITY_AUTHENTICATION_AESGCMGMACFAST_TRANSFORM_H_
#define _SECURITY_AUTHENTICATION_AESGCMGMACFAST_TRANSFORM_H_
...
class AESGCMGMACFAST_Transform : public CryptoTransform
{
public:

    AESGCMGMACFAST_Transform();
    ~AESGCMGMACFAST_Transform();
    ...
    bool serialize_SecureDataBody_precomputation(
            eprosima::fastcdr::Cdr& serializer,
    ...
    bool deserialize_SecureDataBody_precomputation(
            eprosima::fastcdr::Cdr& decoder,
            eprosima::fastcdr::Cdr::state& body_state,
            SecureDataTag& tag,
            uint32_t body_length,
    ...
    void set_for_writer_precomputation(
            AESGCMGMACFAST_WriterCryptoHandleImpl& handle,
    ...
    void set_for_reader_precomputation(
            AESGCMGMACFAST_ReaderCryptoHandleImpl& handle,
            std::array<uint8_t, 32> sessionKey, int sessionId);

    std::array<uint8_t, 8> build_iv_suffix(const eprosima::fastrtps::rtps::security::KeySessionData* session);

    bool is_vaild_gcm_kind(const CryptoTransformKind& transformation_kind);
...
#endif // _SECURITY_AUTHENTICATION_AESGCMGMACFAST_TRANSFORM_H_
