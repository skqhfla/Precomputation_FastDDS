...
/*!
 * @file AESGCMGMACFAST_KeyExchange.h
 */

#ifndef _SECURITY_AUTHENTICATION_AESGCMGMACFAST_KEYEXCHANGE_H_
#define _SECURITY_AUTHENTICATION_AESGCMGMACFAST_KEYEXCHANGE_H_
...
class AESGCMGMACFAST_KeyExchange : public CryptoKeyExchange
{
    public:

    AESGCMGMACFAST_KeyExchange();
    ~AESGCMGMACFAST_KeyExchange();
...
#endif // _SECURITY_AUTHENTICATION_AESGCMGMACFAST_KEYEXCHANGE_H_
