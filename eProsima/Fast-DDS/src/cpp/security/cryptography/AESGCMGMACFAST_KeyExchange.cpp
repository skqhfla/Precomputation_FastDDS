...
/*!
 * @file AESGCMGMACFAST_KeyExchange.cpp
 */

#include "AESGCMGMACFAST_KeyExchange.h"
...
AESGCMGMACFAST_KeyExchange::AESGCMGMACFAST_KeyExchange()
{
}
...
bool AESGCMGMACFAST_KeyExchange::create_local_participant_crypto_tokens(
        ...
        SecurityException& /*exception*/)
{
    ...
    const AESGCMGMACFAST_ParticipantCryptoHandle& local_participant = AESGCMGMACFAST_ParticipantCryptoHandle::narrow(
        local_participant_crypto);
    AESGCMGMACFAST_ParticipantCryptoHandle& remote_participant = AESGCMGMACFAST_ParticipantCryptoHandle::narrow(
...
bool AESGCMGMACFAST_KeyExchange::set_remote_participant_crypto_tokens(
        const ParticipantCryptoHandle& local_participant_crypto,
        ParticipantCryptoHandle& remote_participant_crypto,
...
bool AESGCMGMACFAST_KeyExchange::create_local_datawriter_crypto_tokens(
        ...
        SecurityException& /*exception*/)
{
    ...
    AESGCMGMACFAST_WriterCryptoHandle& local_writer = AESGCMGMACFAST_WriterCryptoHandle::narrow(local_datawriter_crypto);
    AESGCMGMACFAST_ReaderCryptoHandle& remote_reader = AESGCMGMACFAST_ReaderCryptoHandle::narrow(remote_datareader_crypto);
...
bool AESGCMGMACFAST_KeyExchange::create_local_datareader_crypto_tokens(
        ...
        SecurityException& /*exception*/)
{
    ...
    AESGCMGMACFAST_ReaderCryptoHandle& local_reader = AESGCMGMACFAST_ReaderCryptoHandle::narrow(local_datareader_crypto);
    AESGCMGMACFAST_WriterCryptoHandle& remote_writer = AESGCMGMACFAST_WriterCryptoHandle::narrow(remote_datawriter_crypto);
...
bool AESGCMGMACFAST_KeyExchange::set_remote_datareader_crypto_tokens(
        DatawriterCryptoHandle& local_datawriter_crypto,
        DatareaderCryptoHandle& remote_datareader_crypto,
...
bool AESGCMGMACFAST_KeyExchange::set_remote_datawriter_crypto_tokens(
        DatareaderCryptoHandle& local_datareader_crypto,
        DatawriterCryptoHandle& remote_datawriter_crypto,
...
bool AESGCMGMACFAST_KeyExchange::return_crypto_tokens(
...
std::vector<uint8_t> AESGCMGMACFAST_KeyExchange::KeyMaterialCDRSerialize(
...
void AESGCMGMACFAST_KeyExchange::KeyMaterialCDRDeserialize(
...
/*
   std::vector<uint8_t> AESGCMGMACFAST_KeyExchange::aes_128_gcm_encrypt(const std::vector<uint8_t>& plaintext,
   ...
   std::vector<uint8_t> AESGCMGMACFAST_KeyExchange::aes_128_gcm_decrypt(const std::vector<uint8_t>& crypto,
        const std::array<uint8_t,32>& key)
   {
