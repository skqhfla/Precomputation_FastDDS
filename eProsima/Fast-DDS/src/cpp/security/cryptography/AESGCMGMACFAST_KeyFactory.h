...
/*!
 * @file AESGCMGMACFAST_KeyFactory.h
 */

#ifndef _SECURITY_AUTHENTICATION_AESGCMGMACFAST_KEYFACTORY_H_
#define _SECURITY_AUTHENTICATION_AESGCMGMACFAST_KEYFACTORY_H_
...
struct ParticipantCryptoHandleDeleter_FAST
{
    ParticipantCryptoHandleDeleter_FAST(
    ...
    std::weak_ptr<AESGCMGMACFAST_KeyFactory> factory_;
};

} // Unnamed namespace

class AESGCMGMACFAST_KeyFactory : public CryptoKeyFactory, public std::enable_shared_from_this<AESGCMGMACFAST_KeyFactory>
{
    friend ParticipantCryptoHandleDeleter_FAST;
...
#endif // _SECURITY_AUTHENTICATION_AESGCMGMACFAST_KEYFACTORY_H_
